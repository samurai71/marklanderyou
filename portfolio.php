    ...
    <article>
    	<div class="row">
          ...
          <!--<div class="stacked-for-small button-group">
           <a class="button" data-rel="all">All</a>
           <a class="button" data-rel="web">Web</a>
           <a class="button" data-rel="ill">Illustration/Painting</a>
           <a class="button" data-rel="photo">Photoshop Work</a>
