    ...
    <article>
        <div class="row">
            <div class="small-12 medium-12 and large-12 columns">
                 <h2>Golf Destination Review</h2>
                 <p>
                <ul class="clearing-thumbs feature" data-clearing>
                 <li><a href="images/GDR.png"><img data-caption="Golf Destination Review Web Site" src="images/thumbs/GDR_thumb.png" class="left photo"></a></li>
