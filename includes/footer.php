     <footer class="footerbar">
      <div class="row">
        <div class="small-12 medium-4 large-4 columns">
          ...
          <img src="images/cdn.gif" alt="Canadian Flag">
        </div>
        <div class="small-12 medium-4  large-4 columns right">
        <h4>London's Weather</h4>
        <div id="plemx-root">
        <a href="http://www.theweathernetwork.com">The Weather Network</a></div> 
        </div>
    ...
    <script src="js/foundation/foundation.orbit.min.js"></script>
