<section id="socialMedia">
        <div class="row">
            <div class="small-12 medium-4 large-4 columns">
                <h2>Social Media</h2>
                <p>To connect with me via Social Networks please click on one of the links in this section.</p>
                <ul class="small-block-grid-4 large-block-grid-4">
                <li><object data="images/facebook.svg" class="socialIcons" id="facebook"></object></li>
                <li><object data="images/twitter.svg" class="socialIcons" id="twitter"></object></li>
                <li><object data="images/linkedin.svg" class="socialIcons" id="linkedin"></object></li>
        ...
        <div class="small-10 medium-4 large-4 columns twitter">
